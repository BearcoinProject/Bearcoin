...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 28147 or testnet: 38147)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 28148 or testnet: 38148)") + "\n" +
        ...
        "\n" + _("SSL options: (see the BearCoin Wiki for SSL setup instructions)") + "\n" +

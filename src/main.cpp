...
#if defined(NDEBUG)
# error "BearCoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xd76fe38851b1224f8dd718f0c5078203945ea7d70b3c53e3936f45762570e30e");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // BearCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "BearCoin Signed Message:\n";
...
{
    // BearCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // BearCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // BearCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1512273323, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "1512263218";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 500 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04c6f1b31bd26962f077745fa2062378e4093b4b7583d6dcdbdc05d5d659c7c8ff8aa535fdd96bc5bf42938039cb687bf7cad52b5d9111b769b83f7cf50f4efb1d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1512273323;
        ...
        assert(block.hashMerkleRoot == uint256("0x5c1b4579fac362a6fda9917c4ff9754897b3a8a79e574f8c20d39e9a8bb6b175"));
...
unsigned char pchMessageStart[4] = { 0x51, 0x0e, 0x26, 0xaa }; // BearCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BearCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BearCoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static BearCoinMiner(CWallet *pwallet)
{
    printf("BearCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("bearcoin-miner");
    ...
    try { loop {
        ...
        printf("Running BearCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BearCoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&BearCoinMiner, pwallet));
}
